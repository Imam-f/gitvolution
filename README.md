...
A local, read-only Electron app for exploring how a Git-tracked file changed over time.
...
2. Search the tracked file list or use its folder button to select a file from disk.
